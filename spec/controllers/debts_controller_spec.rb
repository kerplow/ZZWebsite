...
RSpec.describe DebtsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: debt.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      debt = Debt.create! valid_attributes
      get :edit, params: {id: debt.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Debt" do
        expect {
          post :create, params: {debt: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {debt: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested debt" do
        debt = Debt.create! valid_attributes
        put :update, params: {id: debt.to_param, debt: new_attributes}, session: valid_session
        debt.reload
      ...
      it "redirects to the debt" do
        debt = Debt.create! valid_attributes
        put :update, params: {id: debt.to_param, debt: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        debt = Debt.create! valid_attributes
        put :update, params: {id: debt.to_param, debt: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested debt" do
      debt = Debt.create! valid_attributes
      expect {
        delete :destroy, params: {id: debt.to_param}, session: valid_session
      }.to change(Debt, :count).by(-1)
    end
